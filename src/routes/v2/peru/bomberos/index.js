...
router.get('/', (req, res) => {
  res.json({
    message: 'API de Bomberos Perú',
    description: 'Obtén información sobre incidentes reportados por los bomberos del Perú',
    endpoints: {
      ...
      'GET /incidentes/status': 'Estado de las actualizaciones automáticas y proxies',
    },
    examples: {
